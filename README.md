...
Solved blue-team challenges involving Windows event analysis, ELK SIEM, AWS/Azure CLI, network forensics, and
Cryptography.
...
- 🛡️ **TryHackMe — SOC Level 1 | https://tryhackme.com/certificate/THM-MVJOSZTUK4**

Hands-on training in SOC operations, alert triage, SIEM, EDR, phishing analysis, network, web, Windows and Linux security
monitoring, malware analysis, threat intelligence, and incident investigation through SOC Level 1 capstone challenges.
- 🤖 **AI Cyber Defense Ops — Cyber Competency Builder | https://learn.justhacking.com/completion/d763d7a82f7d4bec**

Hands-on training in AI-assisted security operations, detection engineering, threat intelligence, security automation,
and cross-SIEM investigations.
- 🧩 **Sisterhood of the Traveling Packets CTF | WiCyS, Flare & SANS Institute | 2026**

Participated in hands-on challenges involving digital forensics, exploitation, decoding, and investigation of a ransomware group's dark web leak site and OPSEC failures.

## 📚 Currently Learning
- 🛡️ TryHackMe SOC Level 1
- 🤖 Cyber Competency Builder — AI Cyber Defense Ops
